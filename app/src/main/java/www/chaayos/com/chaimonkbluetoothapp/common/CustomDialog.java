    ...
    public void showDialog(final Context context) {
        ...
        connectButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ((ChaiMonkActivity) context).connectToMonk(ChaiMonkEnum.CHAI_MONK1.toString());
                dialog.dismiss();
            }
        });
        ...
        cancelButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((ChaiMonkActivity) context).sendCommandToMonk(chaiMonkMap.get(ChaiMonkEnum.CHAI_MONK1), Constants.ChaiMonkCommand.STOP);
                dialog.dismiss();
            }
        });
        ...
        cleanButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((ChaiMonkActivity) context).sendCommandToMonk(chaiMonkMap.get(ChaiMonkEnum.CHAI_MONK1), Constants.ChaiMonkCommand.CLEAN);
                dialog.dismiss();
            }
        });
        ...
        pauseResumeButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (pauseResumeButton.getText().equals("Pause")) {
                    ((ChaiMonkActivity) context).sendCommandToMonk(chaiMonkMap.get(ChaiMonkEnum.CHAI_MONK1), Constants.ChaiMonkCommand.PAUSE);
                    pauseResumeButton.setText("Resume");
                    dialog.dismiss();
                } else if (pauseResumeButton.getText().equals("Resume")) {
                    ((ChaiMonkActivity) context).sendCommandToMonk(chaiMonkMap.get(ChaiMonkEnum.CHAI_MONK1), Constants.ChaiMonkCommand.RESUME);
